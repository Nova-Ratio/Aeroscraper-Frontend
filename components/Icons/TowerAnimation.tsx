  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col items-center ml-8 gap-2">
        <TowerPrimaryIcon isGradient={checkThatTime(1)} />
        <TowerSecondaryIcon isGradient={checkThatTime(2)} />
...
const TowerPrimaryIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.7 }} width="123" height="155" viewBox="0 0 123 155" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_1687" x1="92.748" y1="1.31345" x2="-13.9803" y2="221.226" gradientUnits="userSpaceOnUse">
...
const TowerSecondaryIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} width="128" height="51" viewBox="0 0 128 51" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_1874" x1="95.7965" y1="0.476605" x2="82.4311" y2="87.3681" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerThirdIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.8 }} width="128" height="51" viewBox="0 0 128 51" fill="none" className="cursor-help">
      <path d="M12.931 50.4731C19.9473 50.4731 25.6518 44.8755 25.8072 37.898C27.2844 34.4385 40.6368 25.7992 63.5323 25.7992C86.4375 25.7992 99.7803 34.4385 101.267 37.898C101.432 44.8755 107.137 50.4731 114.143 50.4731C121.247 50.4731 127.02 44.7006 127.02 37.5968C127.02 16.538 99.1389 0.0466309 63.5323 0.0466309C27.9452 0.0466309 0.0546998 16.538 0.0546998 37.5968C0.0449818 44.7103 5.8077 50.4731 12.931 50.4731Z" fill={isGradient ? "url(#paint0_linear_859_1687)" : "rgb(247,247,255,0.4)"} />
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_1874" x1="95.7965" y1="0.476605" x2="82.4311" y2="87.3681" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
...
const TowerFourthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.85 }} width="132" height="45" viewBox="0 0 132 45" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2061" x1="99.0941" y1="0.836475" x2="89.1597" y2="77.2822" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerFifthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.9 }} width="202" height="57" viewBox="0 0 202 57" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2248" x1="152.177" y1="0.692434" x2="141.539" y2="98.9442" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerSixthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.95 }} width="202" height="53" viewBox="0 0 202 53" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2435" x1="152.177" y1="0.993491" x2="143.003" y2="92.3102" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerSeventhIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 0.98 }} width="202" height="48" viewBox="0 0 202 48" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2614" x1="152.177" y1="1.25583" x2="144.838" y2="83.0133" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerEighthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 0.8 }} animate={{ scale: isGradient ? 1.2 : 1 }} transition={{ duration: 0.4, delay: 1 }} width="299" height="54" viewBox="0 0 299 54" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2810" x1="206.132" y1="0.765559" x2="200.932" y2="94.7561" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerNinthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 1 }} animate={{ scale: isGradient ? 1.2 : 1.1 }} transition={{ duration: 0.4, delay: 1.1 }} width="299" height="54" viewBox="0 0 299 54" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_2997" x1="207.326" y1="0.502863" x2="202.057" y2="94.4858" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerTenthIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 1 }} animate={{ scale: isGradient ? 1.3 : 1.1 }} transition={{ duration: 0.4, delay: 1.1 }} width="303" height="50" viewBox="0 0 303 50" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_3184" x1="209.796" y1="1.21216" x2="205.551" y2="86.7089" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
...
const TowerEleventhIcon: FC<SvgProps> = ({ isGradient }) => {
  return (
    <motion.svg initial={{ scale: 1 }} animate={{ scale: isGradient ? 1.3 : 1.3 }} transition={{ duration: 0.4, delay: 1.1 }} width="303" height="50" viewBox="0 0 303 50" fill="none" className="cursor-help">
      ...
      <defs>
        <linearGradient className={"shape-animation"} id="paint0_linear_859_3371" x1="209.796" y1="1.2356" x2="205.551" y2="86.7324" gradientUnits="userSpaceOnUse">
          <stop stop-color="#56235C" />
          <stop offset="0.294825" stop-color="#D43752" />
          <stop offset="0.402713" stop-color="#E4462D" />
          <stop offset="0.638994" stop-color="#F8B810" />
