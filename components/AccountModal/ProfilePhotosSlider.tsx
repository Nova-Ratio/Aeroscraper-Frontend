import React, { useRef, useState, useLayoutEffect } from 'react';  // <-- Add missing imports
...
// Update the type of props to be Props instead of any
const ProfilePhotoSlider: React.FC<Props> = (props: Props) => {  // <-- Update here
