    ...
    <div>
      <main>
        <div className="max-w-[626px] md:ml-[200px] p-6 md:p-0">
          ...
          <h1 className="text-white text-[36px] md:text-[64px] leading-[46px] md:leading-[72px] font-semibold mt-32 md:mt-10">
            Your decentralized lending-borrowing protocol
          </h1>
          <h2 className="text-base text-ghost-white font-medium mt-10">
            Empowering you with autonomy and direct transactions. Interest-free,
            over-collateralized stablecoin and DeFi loans. Fully automated and
            governance-free, which enables unauthorized lending and borrowing.
            <br />
            <br />
            The protocol only charges a one-time fee. Deposit collateral and
            access loans in stablecoins pegged to the US dollar.
          </h2>
          <Link href={"/app/dashboard"}>
            <GradientButton className="w-full lg:w-[227px] h-[37px] rounded-lg self-end px-8 group mt-10">
        ...
        <InjectiveBackgroundWave
          animate
          className="absolute top-40 md:-top-3 right-0 -z-10 md:w-[1200px] w-[300px]"
        />
      </main>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-40">
          <div className="flex flex-col content-start justify-start gap-4">
            ...
            <Link
              ...
              className="hover:scale-105 w-fit transition-all flex gap-2"
            >
