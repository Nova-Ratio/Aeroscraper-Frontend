...
const StabilityPoolTab: FC<Props> = ({ pageData, getPageData }) => {
  ...
  return (
    <div className="-ml-4">
      ...
      <Text size='base' weight='font-regular' className='mt-1'>Deposit or Withdraw AUSD from your wallet to the Aeroscaper protocol to earn rewards. </Text>
      {
        pageData.stakedAmount > 0 &&
        <>
          <div className='flex flex-col gap-8 mt-8'>
            <Checkbox label={'Deposit'} checked={selectedTab === TABS.DEPOSIT} onChange={() => { setSelectedTab(TABS.DEPOSIT); }} />
            <Checkbox label={'Withdraw'} checked={selectedTab === TABS.WITHDRAW} onChange={() => { setSelectedTab(TABS.WITHDRAW); }} />
          </div>
        </>
      }
